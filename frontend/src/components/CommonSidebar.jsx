...
const CommonSidebar = ({role}) => {
  ...
  const menuItems = [
    ...
    { text: 'others', icon: <MoreHorizIcon /> },
  ];

  const ownerItems = [
    { text: 'dashboard', icon: <DashboardIcon />, path: '/owner/dashboard' },
    { text: 'Book Upload', icon: <BookIcon />, path: '/owner/upload' },
    { text: 'Others', icon: <MoreHorizIcon />,path:'#' },
    { text: 'Others', icon: <MoreHorizIcon />,path:'#' },
  ]

  const secondaryMenuItems = [
    { text: 'notifications', icon: <NotificationsIcon />,path:'#' },
    { text: 'settings', icon: <SettingsIcon />,path:'#' },
    { text: 'Login as Book Owner', icon: <PersonIcon />,path:'/login' },
  ]
